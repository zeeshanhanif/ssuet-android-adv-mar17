...
import jsonexampleone.firebasedemoone.MessagesActivity;
...
public class Contacts extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        users = new ArrayList<>();
        final PagerRecyclerAdapter adapter = new PagerRecyclerAdapter(users, new PagerRecyclerAdapter.ItemClickListener() {
            @Override
